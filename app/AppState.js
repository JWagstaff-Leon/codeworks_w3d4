...
// @ts-ignore
const res2 = new Reservation({type: 'Vacation', name: 'Jerry', confimationNumber: 'POJN42N', address: '163 No Way', startDate: '10/31/22', notes: 'notey2', cost: 500, tripId: 'hi'})
// @ts-ignore
const res3 = new Reservation({type: 'Moving', name: 'Louis', confimationNumber: 'UHNG42N', address: '985 Free Way', startDate: '08/18/22', notes: 'notey3', cost: 1000, tripId: 'hi'})
// @ts-ignore
const res4 = new Reservation({type: 'Vacation', name: 'Sarah', confimationNumber: 'RESC98N', address: '513 Lee Way', startDate: '06/21/23', notes: 'notey4', cost: 700, tripId: 'hi'})
// @ts-ignore
const res5 = new Reservation({type: 'Business', name: 'Irene', confimationNumber: 'ESXC95N', address: '230 Hi Way', startDate: '04/05/23', notes: 'notey5', cost: 800, tripId: 'hi'})
